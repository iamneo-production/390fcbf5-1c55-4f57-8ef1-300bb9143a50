...
public class Stepdefinition {
	...
	@When("^admin opens url \"([^\"]*)\"$")
	public void admin_opens_url(String arg1) throws Throwable {
		driver.get(arg1);
	}

	@Then("^admin should able to see the admin signin page$")
	public void admin_should_able_to_see_the_admin_signin_page() throws Throwable {
	...
	public void admin_enters_username_as_and_password_as(String arg1, String arg2) throws Throwable {
	...
	public void admin_should_able_to_view_car_rental_portal_admin_panel() throws Throwable {
		driver.get("https://carrental.neohire.io/");
		driver.manage().window().maximize();
	}

	@When("^admin click on Dashboard$")
	public void admin_click_on_Dashboard() throws Throwable {
		dashboard.dashboardButton();
	}

	@When("^click on Reg Users Full Detail link$")
	public void click_on_Reg_Users_Full_Detail_link() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
	...
	public void admin_should_be_navigated_to_Registered_Users_Page() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
	...
	public void admin_click_on_Listed_Vehicles_Full_Detail_link() throws Throwable {
		dashboard.listVehButton();
	}

	@Then("^admin should be navigated to Manage Vehicles Page$")
	public void admin_should_be_navigated_to_Manage_Vehicles_Page() throws Throwable {
		dashboard.checkManVeh();
	 	driver.navigate().back();
	}

	@When("^admin click on Total Bookings Full Detail link$")
	public void admin_click_on_Total_Bookings_Full_Detail_link() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@Then("^admin should be navigated to Manage Bookings Page$")
	public void admin_should_be_navigated_to_Manage_Bookings_Page() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@When("^admin click on Listed Brands Full Detail link$")
	public void admin_click_on_Listed_Brands_Full_Detail_link() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@Then("^admin should be navigated to Manage Brands Page$")
	public void admin_should_be_navigated_to_Manage_Brands_Page() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@When("^admin click on Subscibers Full Detail link$")
	public void admin_click_on_Subscibers_Full_Detail_link() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@Then("^admin should be navigated to Manage Subscribers Page$")
	public void admin_should_be_navigated_to_Manage_Subscribers_Page() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@When("^admin click on Queries Full Detail link$")
	public void admin_click_on_Queries_Full_Detail_link() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@Then("^admin should be navigated to Manage Contact Us Queries Page$")
	public void admin_should_be_navigated_to_Manage_Contact_Us_Queries_Page() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@When("^admin click on Testimonials Full Detail link$")
	public void admin_click_on_Testimonials_Full_Detail_link() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@Then("^admin should be navigated to Manage Testimonials Page$")
	public void admin_should_be_navigated_to_Manage_Testimonials_Page() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@When("^admin click on Account option$")
	public void admin_click_on_Account_option() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
	...
	public void admin_navigates_to_Admin_SignIn_page() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
